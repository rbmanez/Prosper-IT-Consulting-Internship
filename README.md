...
- Created a map, implemented an API call and displayed the response data, and designed responsive and interactive web pages for a Python and Django based space research application.
